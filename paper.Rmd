...
ggsave("figures/Figure 2.png", width = 8, height = 4)
```
...
new_dt %>% 
  group_by(herbicide) %>% 
  summarise(biomass = mean(biomass_gm2, na.rm = TRUE),
            counts = mean(counts_m2, na.rm = TRUE))
```

```{r}
epred4 <- emmeans(model4, "herbicide", epred = TRUE,
                  #cont="pairwise"
                  )
epred4
```
...
epred4_wt1 %>%
  mutate(herbicide = fct_relevel(herbicide,
                                 levels = c("glufosinate", "glufosinate + dimethenamid-P",
                                            "glufosinate + imazethapyr", 
                                            "glufosinate + *S*-metolachlor",
                                            "glufosinate + pyroxasulfone", 
                                            "glufosinate + acetochlor", "glufosinate + fomesafen",
                                            "glufosinate + fomesafen + acetochlor",
                                            "glufosinate + fomesafen + *S*-metolachlor"))) -> epred4_wt1
```
