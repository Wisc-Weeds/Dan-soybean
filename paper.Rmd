...
epred1_1 %>% 
  ...
  mutate(herbicide = fct_recode(herbicide,
                                "PRE fb glufosinate + fomesafen + *S*-metolachlor" = "PRE fb glufosinate + fomesafen + S-metolachlor")) -> epred_wt
```
...
ggsave("figures/Figure 1.png", width = 9)
```
